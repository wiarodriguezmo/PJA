...
if(!empty($_SESSION)){
	...
	$twig->display('todContratos.html',array(
		"titulo"    		=> "Listado de todos los contratos (Asociativos/Familiar/Colectivos)",
