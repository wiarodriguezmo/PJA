...
--
-- Servidor: localhost
-- Tiempo de generación: 02-09-2013 a las 06:32:51
...
CREATE TABLE `tbl_estados` (
  `id_estado` smallint(2) NOT NULL AUTO_INCREMENT COMMENT 'id unico del estado',
  `edo_nombre` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nombre completo del estado',
  `edo_abr` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Abreviatura del estado',
  PRIMARY KEY (`id_estado`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lista de Estados de la República Mexicana' AUTO_INCREMENT=33 ;

--
-- Volcado de datos para la tabla `tbl_estados`
--

INSERT INTO `tbl_estados` (`id_estado`, `edo_nombre`, `edo_abr`) VALUES
...
CREATE TABLE `tbl_municipios` (
  `id_municipio` smallint(5) NOT NULL COMMENT 'id unico del municipio',
  `id_estado` smallint(2) NOT NULL COMMENT 'id de relación con el estado',
  `mun_nombre` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nombre del municipio'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lista de municipios de la República Mexicana';

--
-- Volcado de datos para la tabla `tbl_municipios`
--

INSERT INTO `tbl_municipios` (`id_municipio`, `id_estado`, `mun_nombre`) VALUES
(1, 1, 'Aguascalientes'),
(2, 1, 'Asientos'),
(3, 1, 'Calvillo'),
(4, 1, 'Cosío'),
...
(1547, 20, 'Heroica Villa Tezoatlán de Segura y Luna, Cuna de la Independencia de Oaxaca'),
...
(1815, 24, 'Alaquines'),
(1816, 24, 'Aquismón'),
(1817, 24, 'Armadillo de los Infante'),
(1818, 24, 'Cárdenas'),
(1819, 24, 'Catorce'),
(1820, 24, 'Cedral'),
(1821, 24, 'Cerritos'),
...
(1853, 24, 'Tamuín'),
(1854, 24, 'Tanlajás'),
(1855, 24, 'Tanquián de Escobedo'),
(1856, 24, 'Tierra Nueva'),
(1857, 24, 'Vanegas'),
(1858, 24, 'Venado'),
(1859, 24, 'Villa de Arriaga'),
(1860, 24, 'Villa de Guadalupe'),
(1861, 24, 'Villa de la Paz'),
(1862, 24, 'Villa de Ramos'),
(1863, 24, 'Villa de Reyes'),
(1864, 24, 'Villa Hidalgo'),
(1865, 24, 'Villa Juárez'),
(1866, 24, 'Axtla de Terrazas'),
(1867, 24, 'Xilitla'),
(1868, 24, 'Zaragoza'),
(1869, 24, 'Villa de Arista'),
(1870, 24, 'Matlapa'),
(1871, 24, 'El Naranjo'),
(1872, 25, 'Ahome'),
(1873, 25, 'Angostura'),
...
(1943, 26, 'San Javier'),
(1944, 26, 'San Luis Río Colorado'),
(1945, 26, 'San Miguel de Horcasitas'),
(1946, 26, 'San Pedro de la Cueva'),
(1947, 26, 'Santa Ana'),
(1948, 26, 'Santa Cruz'),
(1949, 26, 'Sáric'),
(1950, 26, 'Soyopa'),
...
(1954, 26, 'Tubutama'),
(1955, 26, 'Ures'),
(1956, 26, 'Villa Hidalgo'),
(1957, 26, 'Villa Pesqueira'),
(1958, 26, 'Yécora'),
(1959, 26, 'General Plutarco Elías Calles'),
(1960, 26, 'Benito Juárez'),
(1961, 26, 'San Ignacio Río Muerto'),
(1962, 27, 'Balancán'),
(1963, 27, 'Cárdenas'),
(1964, 27, 'Centla'),
(1965, 27, 'Centro'),
(1966, 27, 'Comalcalco'),
(1967, 27, 'Cunduacán'),
(1968, 27, 'Emiliano Zapata'),
(1969, 27, 'Huimanguillo'),
(1970, 27, 'Jalapa'),
(1971, 27, 'Jalpa de Méndez'),
(1972, 27, 'Jonuta'),
(1973, 27, 'Macuspana'),
(1974, 27, 'Nacajuca'),
(1975, 27, 'Paraíso'),
...
(1980, 28, 'Aldama'),
(1981, 28, 'Altamira'),
(1982, 28, 'Antiguo Morelos'),
(1983, 28, 'Burgos'),
(1984, 28, 'Bustamante'),
(1985, 28, 'Camargo'),
(1986, 28, 'Casas'),
(1987, 28, 'Ciudad Madero'),
(1988, 28, 'Cruillas'),
(1989, 28, 'Gómez Farías'),
(1990, 28, 'González'),
(1991, 28, 'Güémez'),
(1992, 28, 'Guerrero'),
(1993, 28, 'Gustavo Díaz Ordaz'),
(1994, 28, 'Hidalgo'),
(1995, 28, 'Jaumave'),
(1996, 28, 'Jiménez'),
(1997, 28, 'Llera'),
...
(2004, 28, 'Miquihuana'),
(2005, 28, 'Nuevo Laredo'),
(2006, 28, 'Nuevo Morelos'),
(2007, 28, 'Ocampo'),
(2008, 28, 'Padilla'),
(2009, 28, 'Palmillas'),
(2010, 28, 'Reynosa'),
(2011, 28, 'Río Bravo'),
(2012, 28, 'San Carlos'),
(2013, 28, 'San Fernando'),
(2014, 28, 'San Nicolás'),
(2015, 28, 'Soto la Marina'),
(2016, 28, 'Tampico'),
(2017, 28, 'Tula'),
(2018, 28, 'Valle Hermoso'),
(2019, 28, 'Victoria'),
(2020, 28, 'Villagrán'),
(2021, 28, 'Xicoténcatl'),
...
(2026, 29, 'Apizaco'),
(2027, 29, 'Calpulalpan'),
(2028, 29, 'El Carmen Tequexquitla'),
(2029, 29, 'Cuapiaxtla'),
(2030, 29, 'Cuaxomulco'),
(2031, 29, 'Chiautempan'),
(2032, 29, 'Muñoz de Domingo Arenas'),
(2033, 29, 'Españita'),
(2034, 29, 'Huamantla'),
(2035, 29, 'Hueyotlipan'),
(2036, 29, 'Ixtacuixtla de Mariano Matamoros'),
(2037, 29, 'Ixtenco'),
(2038, 29, 'Mazatecochco de José María Morelos'),
(2039, 29, 'Contla de Juan Cuamatzi'),
(2040, 29, 'Tepetitla de Lardizábal'),
(2041, 29, 'Sanctórum de Lázaro Cárdenas'),
(2042, 29, 'Nanacamilpa de Mariano Arista'),
(2043, 29, 'Acuamanala de Miguel Hidalgo'),
(2044, 29, 'Natívitas'),
(2045, 29, 'Panotla'),
(2046, 29, 'San Pablo del Monte'),
(2047, 29, 'Santa Cruz Tlaxcala'),
(2048, 29, 'Tenancingo'),
(2049, 29, 'Teolocholco'),
(2050, 29, 'Tepeyanco'),
(2051, 29, 'Terrenate'),
(2052, 29, 'Tetla de la Solidaridad'),
(2053, 29, 'Tetlatlahuca'),
(2054, 29, 'Tlaxcala'),
(2055, 29, 'Tlaxco'),
(2056, 29, 'Tocatlán'),
(2057, 29, 'Totolac'),
(2058, 29, 'Ziltlaltépec de Trinidad Sánchez Santos'),
(2059, 29, 'Tzompantepec'),
(2060, 29, 'Xaloztoc'),
(2061, 29, 'Xaltocan'),
(2062, 29, 'Papalotla de Xicohténcatl'),
(2063, 29, 'Xicohtzinco'),
(2064, 29, 'Yauhquemehcan'),
(2065, 29, 'Zacatelco'),
(2066, 29, 'Benito Juárez'),
(2067, 29, 'Emiliano Zapata'),
(2068, 29, 'Lázaro Cárdenas'),
(2069, 29, 'La Magdalena Tlaltelulco'),
(2070, 29, 'San Damián Texóloc'),
(2071, 29, 'San Francisco Tetlanohcan'),
(2072, 29, 'San Jerónimo Zacualpan'),
(2073, 29, 'San José Teacalco'),
(2074, 29, 'San Juan Huactzinco'),
(2075, 29, 'San Lorenzo Axocomanitla'),
(2076, 29, 'San Lucas Tecopilco'),
(2077, 29, 'Santa Ana Nopalucan'),
(2078, 29, 'Santa Apolonia Teacalco'),
(2079, 29, 'Santa Catarina Ayometla'),
(2080, 29, 'Santa Cruz Quilehtla'),
(2081, 29, 'Santa Isabel Xiloxoxtla'),
(2082, 30, 'Acajete'),
(2083, 30, 'Acatlán'),
(2084, 30, 'Acayucan'),
(2085, 30, 'Actopan'),
(2086, 30, 'Acula'),
(2087, 30, 'Acultzingo'),
(2088, 30, 'Camarón de Tejeda'),
(2089, 30, 'Alpatláhuac'),
(2090, 30, 'Alto Lucero de Gutiérrez Barrios'),
(2091, 30, 'Altotonga'),
(2092, 30, 'Alvarado'),
(2093, 30, 'Amatitlán'),
(2094, 30, 'Naranjos Amatlán'),
(2095, 30, 'Amatlán de los Reyes'),
(2096, 30, 'Angel R. Cabada'),
(2097, 30, 'La Antigua'),
(2098, 30, 'Apazapan'),
(2099, 30, 'Aquila'),
(2100, 30, 'Astacinga'),
...
(2106, 30, 'Ayahualulco'),
(2107, 30, 'Banderilla'),
(2108, 30, 'Benito Juárez'),
(2109, 30, 'Boca del Río'),
(2110, 30, 'Calcahualco'),
(2111, 30, 'Camerino Z. Mendoza'),
(2112, 30, 'Carrillo Puerto'),
(2113, 30, 'Catemaco'),
(2114, 30, 'Cazones de Herrera'),
(2115, 30, 'Cerro Azul'),
(2116, 30, 'Citlaltépetl'),
(2117, 30, 'Coacoatzintla'),
(2118, 30, 'Coahuitlán'),
(2119, 30, 'Coatepec'),
(2120, 30, 'Coatzacoalcos'),
(2121, 30, 'Coatzintla'),
(2122, 30, 'Coetzala'),
(2123, 30, 'Colipa'),
(2124, 30, 'Comapa'),
(2125, 30, 'Córdoba'),
(2126, 30, 'Cosamaloapan de Carpio'),
(2127, 30, 'Cosautlán de Carvajal'),
(2128, 30, 'Coscomatepec'),
(2129, 30, 'Cosoleacaque'),
(2130, 30, 'Cotaxtla'),
(2131, 30, 'Coxquihui'),
(2132, 30, 'Coyutla'),
(2133, 30, 'Cuichapa'),
(2134, 30, 'Cuitláhuac'),
(2135, 30, 'Chacaltianguis'),
(2136, 30, 'Chalma'),
(2137, 30, 'Chiconamel'),
(2138, 30, 'Chiconquiaco'),
(2139, 30, 'Chicontepec'),
(2140, 30, 'Chinameca'),
(2141, 30, 'Chinampa de Gorostiza'),
(2142, 30, 'Las Choapas'),
(2143, 30, 'Chocamán'),
(2144, 30, 'Chontla'),
(2145, 30, 'Chumatlán'),
(2146, 30, 'Emiliano Zapata'),
(2147, 30, 'Espinal'),
(2148, 30, 'Filomeno Mata'),
(2149, 30, 'Fortín'),
(2150, 30, 'Gutiérrez Zamora'),
(2151, 30, 'Hidalgotitlán'),
(2152, 30, 'Huatusco'),
(2153, 30, 'Huayacocotla'),
(2154, 30, 'Hueyapan de Ocampo'),
(2155, 30, 'Huiloapan de Cuauhtémoc'),
(2156, 30, 'Ignacio de la Llave'),
(2157, 30, 'Ilamatlán'),
(2158, 30, 'Isla'),
(2159, 30, 'Ixcatepec'),
(2160, 30, 'Ixhuacán de los Reyes'),
(2161, 30, 'Ixhuatlán del Café'),
(2162, 30, 'Ixhuatlancillo'),
(2163, 30, 'Ixhuatlán del Sureste'),
(2164, 30, 'Ixhuatlán de Madero'),
(2165, 30, 'Ixmatlahuacan'),
(2166, 30, 'Ixtaczoquitlán'),
(2167, 30, 'Jalacingo'),
(2168, 30, 'Xalapa'),
(2169, 30, 'Jalcomulco'),
(2170, 30, 'Jáltipan'),
(2171, 30, 'Jamapa'),
(2172, 30, 'Jesús Carranza'),
(2173, 30, 'Xico'),
(2174, 30, 'Jilotepec'),
(2175, 30, 'Juan Rodríguez Clara'),
(2176, 30, 'Juchique de Ferrer'),
(2177, 30, 'Landero y Coss'),
(2178, 30, 'Lerdo de Tejada'),
(2179, 30, 'Magdalena'),
(2180, 30, 'Maltrata'),
(2181, 30, 'Manlio Fabio Altamirano'),
(2182, 30, 'Mariano Escobedo'),
(2183, 30, 'Martínez de la Torre'),
(2184, 30, 'Mecatlán'),
(2185, 30, 'Mecayapan'),
(2186, 30, 'Medellín'),
(2187, 30, 'Miahuatlán'),
...
(2200, 30, 'Otatitlán'),
(2201, 30, 'Oteapan'),
(2202, 30, 'Ozuluama de Mascareñas'),
(2203, 30, 'Pajapan'),
(2204, 30, 'Pánuco'),
(2205, 30, 'Papantla'),
(2206, 30, 'Paso del Macho'),
(2207, 30, 'Paso de Ovejas'),
(2208, 30, 'La Perla'),
(2209, 30, 'Perote'),
(2210, 30, 'Platón Sánchez'),
(2211, 30, 'Playa Vicente'),
(2212, 30, 'Poza Rica de Hidalgo'),
(2213, 30, 'Las Vigas de Ramírez'),
(2214, 30, 'Pueblo Viejo'),
(2215, 30, 'Puente Nacional'),
(2216, 30, 'Rafael Delgado'),
(2217, 30, 'Rafael Lucio'),
(2218, 30, 'Los Reyes'),
(2219, 30, 'Río Blanco'),
(2220, 30, 'Saltabarranca'),
(2221, 30, 'San Andrés Tenejapan'),
(2222, 30, 'San Andrés Tuxtla'),
(2223, 30, 'San Juan Evangelista'),
(2224, 30, 'Santiago Tuxtla'),
(2225, 30, 'Sayula de Alemán'),
(2226, 30, 'Soconusco'),
(2227, 30, 'Sochiapa'),
(2228, 30, 'Soledad Atzompa'),
(2229, 30, 'Soledad de Doblado'),
(2230, 30, 'Soteapan'),
(2231, 30, 'Tamalín'),
(2232, 30, 'Tamiahua'),
(2233, 30, 'Tampico Alto'),
(2234, 30, 'Tancoco'),
(2235, 30, 'Tantima'),
(2236, 30, 'Tantoyuca'),
(2237, 30, 'Tatatila'),
(2238, 30, 'Castillo de Teayo'),
(2239, 30, 'Tecolutla'),
(2240, 30, 'Tehuipango'),
(2241, 30, 'Álamo Temapache'),
(2242, 30, 'Tempoal'),
(2243, 30, 'Tenampa'),
(2244, 30, 'Tenochtitlán'),
(2245, 30, 'Teocelo'),
(2246, 30, 'Tepatlaxco'),
(2247, 30, 'Tepetlán'),
(2248, 30, 'Tepetzintla'),
...
(2253, 30, 'Texistepec'),
(2254, 30, 'Tezonapa'),
(2255, 30, 'Tierra Blanca'),
(2256, 30, 'Tihuatlán'),
(2257, 30, 'Tlacojalpan'),
(2258, 30, 'Tlacolulan'),
(2259, 30, 'Tlacotalpan'),
(2260, 30, 'Tlacotepec de Mejía'),
(2261, 30, 'Tlachichilco'),
(2262, 30, 'Tlalixcoyan'),
(2263, 30, 'Tlalnelhuayocan'),
(2264, 30, 'Tlapacoyan'),
(2265, 30, 'Tlaquilpa'),
(2266, 30, 'Tlilapan'),
(2267, 30, 'Tomatlán'),
...
(2270, 30, 'Tuxpan'),
(2271, 30, 'Tuxtilla'),
(2272, 30, 'Ursulo Galván'),
(2273, 30, 'Vega de Alatorre'),
(2274, 30, 'Veracruz'),
(2275, 30, 'Villa Aldama'),
(2276, 30, 'Xoxocotla'),
(2277, 30, 'Yanga'),
(2278, 30, 'Yecuatla'),
(2279, 30, 'Zacualpan'),
...
(2281, 30, 'Zentla'),
(2282, 30, 'Zongolica'),
(2283, 30, 'Zontecomatlán de López y Fuentes'),
(2284, 30, 'Zozocolco de Hidalgo'),
(2285, 30, 'Agua Dulce'),
(2286, 30, 'El Higo'),
(2287, 30, 'Nanchital de Lázaro Cárdenas del Río'),
(2288, 30, 'Tres Valles'),
(2289, 30, 'Carlos A. Carrillo'),
(2290, 30, 'Tatahuicapan de Juárez'),
(2291, 30, 'Uxpanapa'),
(2292, 30, 'San Rafael'),
(2293, 30, 'Santiago Sochiapan'),
(2294, 31, 'Abalá'),
(2295, 31, 'Acanceh'),
(2296, 31, 'Akil'),
(2297, 31, 'Baca'),
...
(2311, 31, 'Chapab'),
(2312, 31, 'Chemax'),
(2313, 31, 'Chicxulub Pueblo'),
(2314, 31, 'Chichimilá'),
(2315, 31, 'Chikindzonot'),
(2316, 31, 'Chocholá'),
(2317, 31, 'Chumayel'),
(2318, 31, 'Dzán'),
(2319, 31, 'Dzemul'),
(2320, 31, 'Dzidzantún'),
(2321, 31, 'Dzilam de Bravo'),
(2322, 31, 'Dzilam González'),
(2323, 31, 'Dzitás'),
(2324, 31, 'Dzoncauich'),
(2325, 31, 'Espita'),
(2326, 31, 'Halachó'),
...
(2351, 31, 'Peto'),
(2352, 31, 'Progreso'),
(2353, 31, 'Quintana Roo'),
(2354, 31, 'Río Lagartos'),
(2355, 31, 'Sacalum'),
(2356, 31, 'Samahil'),
(2357, 31, 'Sanahcat'),
(2358, 31, 'San Felipe'),
...
(2368, 31, 'Teabo'),
(2369, 31, 'Tecoh'),
(2370, 31, 'Tekal de Venegas'),
(2371, 31, 'Tekantó'),
(2372, 31, 'Tekax'),
(2373, 31, 'Tekit'),
(2374, 31, 'Tekom'),
(2375, 31, 'Telchac Pueblo'),
(2376, 31, 'Telchac Puerto'),
(2377, 31, 'Temax'),
(2378, 31, 'Temozón'),
(2379, 31, 'Tepakán'),
(2380, 31, 'Tetiz'),
...
(2401, 32, 'Apulco'),
(2402, 32, 'Atolinga'),
(2403, 32, 'Benito Juárez'),
(2404, 32, 'Calera'),
(2405, 32, 'Cañitas de Felipe Pescador'),
(2406, 32, 'Concepción del Oro'),
(2407, 32, 'Cuauhtémoc'),
(2408, 32, 'Chalchihuites'),
(2409, 32, 'Fresnillo'),
(2410, 32, 'Trinidad García de la Cadena'),
(2411, 32, 'Genaro Codina'),
(2412, 32, 'General Enrique Estrada'),
(2413, 32, 'General Francisco R. Murguía'),
(2414, 32, 'El Plateado de Joaquín Amaro'),
(2415, 32, 'General Pánfilo Natera'),
(2416, 32, 'Guadalupe'),
(2417, 32, 'Huanusco'),
(2418, 32, 'Jalpa'),
(2419, 32, 'Jerez'),
(2420, 32, 'Jiménez del Teul'),
(2421, 32, 'Juan Aldama'),
(2422, 32, 'Juchipila'),
(2423, 32, 'Loreto'),
(2424, 32, 'Luis Moya'),
(2425, 32, 'Mazapil'),
(2426, 32, 'Melchor Ocampo'),
(2427, 32, 'Mezquital del Oro'),
(2428, 32, 'Miguel Auza'),
(2429, 32, 'Momax'),
(2430, 32, 'Monte Escobedo'),
(2431, 32, 'Morelos'),
(2432, 32, 'Moyahua de Estrada'),
(2433, 32, 'Nochistlán de Mejía'),
(2434, 32, 'Noria de Ángeles'),
(2435, 32, 'Ojocaliente'),
(2436, 32, 'Pánuco'),
(2437, 32, 'Pinos'),
(2438, 32, 'Río Grande'),
...
(2444, 32, 'Tepechitlán'),
(2445, 32, 'Tepetongo'),
(2446, 32, 'Teúl de González Ortega'),
(2447, 32, 'Tlaltenango de Sánchez Román'),
(2448, 32, 'Valparaíso'),
(2449, 32, 'Vetagrande'),
(2450, 32, 'Villa de Cos'),
(2451, 32, 'Villa García'),
(2452, 32, 'Villa González Ortega'),
(2453, 32, 'Villa Hidalgo'),
(2454, 32, 'Villanueva'),
(2455, 32, 'Zacatecas'),
(2456, 32, 'Trancoso'),
(2457, 32, 'Santa María de la Paz');
